...
<div style="max-width: 480px; margin: 0 auto; padding: 20px; font-family: Arial, Helvetica, sans-serif; color: #000;">
    ...
    <p>Thành viên {{$content["updater"]->lastName}} {{$content["updater"]->firstName}}vừa thay đổi một số thông tin của task {{$content["errorName"]}} như sau:</p>
    @foreach($content["listUpdate"] as $update)
